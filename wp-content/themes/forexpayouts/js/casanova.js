...
(function () {
    ...
    casanova.stats = function () {
		...
		el.appear().one('appear', function () {
				...
				anim = new countUp($(this).attr('id'), 0, countto, decimal, 1, 2.5);
        ...
        //el.appear().one('appear', function () {
//				var num  = $(this).find('.number').parent(),
//                anim = new countUp(num.attr('id'), 0, $('.number.delays').text().replace(',', ''), 4.9, 1, 2.5);
//				anim.start();
//        });
//		
//		el.appear().one('appear', function () {
//            var num  = $(this).find('.number.luggage').parent(),
//                anim = new countUp(num.attr('id'), 0, $('.number.luggage').text().replace(',', ''), 1, 1, 2.5);
//
//            anim.start();
//        });
//		
//		el.appear().one('appear', function () {
//            var num  = $(this).find('.number.hospital'),
//                anim = new countUp(num.attr('id'), 0, num.text().replace(',', ''), 1, 1, 2.5);
//
//            anim.start();
//        });
