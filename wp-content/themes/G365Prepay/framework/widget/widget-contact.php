...
class contactinfo extends WP_Widget {
    ...
    function contactinfo() {
        ...
        parent::WP_Widget(false, 'Evatheme contact info', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_title') ); ?>"><?php _e('Title:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_address') ); ?>"><?php _e('Content address:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_phone') ); ?>"><?php _e('Contact phone number:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_email_url') ); ?>"><?php _e('Contact email link url:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_email') ); ?>"><?php _e('Contact email:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_web_url') ); ?>"><?php _e('Contact web link url:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_web') ); ?>"><?php _e('Contact web:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_facebook_url') ); ?>"><?php _e('Contact facebook link url:', 'evatheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('contact_facebook') ); ?>"><?php _e('Contact facebook:', 'evatheme'); ?></label>
    ...
    function widget($args, $instance) {
        ...
        if (!empty($contact_title)) {
            echo htmlspecialchars_decode( esc_html( $before_title . $contact_title . $after_title ) );
        }
        echo '<div class="contact-info-widget">';
            echo '<ul>';
                if(!empty($contact_address)){
                    echo '<li><i class="icon-map-marker"></i><div>'.esc_html( $contact_address ).'</div></li>';
                }
                if(!empty($contact_phone)){
                    echo '<li><i class="icon-phone"></i><div>'.esc_html( $contact_phone ).'</div></li>';
                }
                if(!empty($contact_email)){
                    echo '<li><i class="icon-envelope-alt"></i><div><a href="mailto:'.esc_attr( $contact_email_url ).'">'.esc_html( $contact_email ).'</a></div></li>';
                }
                if(!empty($contact_web)){
                    echo '<li><i class="icon-globe"></i><div><a target="_blank" href="'.esc_url( to_url($contact_web_url) ).'">'.esc_html( $contact_web ).'</a></div></li>';
                }
                if(!empty($contact_facebook)){
                    echo '<li><i class="icon-facebook"></i><div><a target="_blank" href="'.esc_url( to_url($contact_facebook_url) ).'">'.esc_html( $contact_facebook ).'</a></div></li>';
                }
            echo '</ul>';
        echo '</div>';
        ?>
