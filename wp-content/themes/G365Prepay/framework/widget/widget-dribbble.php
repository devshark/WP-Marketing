...
class dribbblewidget extends WP_Widget {
    ...
    function dribbblewidget() {
        ...
        parent::WP_Widget(false, 'Evatheme dribbble', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr( $this->get_field_id('dribbble_title') ); ?>"><?php _e('Title:', 'evatheme'); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('dribbble_title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('dribbble_title') ); ?>" type="text" value="<?php echo esc_attr($dribbble_title); ?>" /></p>
        <p><label for="<?php echo esc_attr( $this->get_field_id('dribbble_userid') ); ?>"><?php _e('dribbble user ID:', 'evatheme'); ?></label>
            <br>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('dribbble_userid') ); ?>" name="<?php echo esc_attr( $this->get_field_name('dribbble_userid') ); ?>" type="text" value="<?php echo esc_attr($dribbble_userid); ?>" />
            <br>
            <?php /* ?><small><em>Find ID <a href="http://dribbble.com/" target="_blank">http://dribbble.com/</a></em></small><?php */ ?>
            <small><em>Find ID <a href="<?php echo esc_url( __( 'http://dribbble.com/', 'evatheme' ) ); ?>" target="_blank"><?php _e( 'http://dribbble.com/', 'evatheme' ); ?></a></em></small>
        </p>

        <p><label for="<?php echo esc_attr( $this->get_field_id('dribbble_num') ); ?>"><?php _e('How many dribbble display:', 'evatheme'); ?></label>
            <input maxlength="3" class="widefat" id="<?php echo esc_attr( $this->get_field_id('dribbble_num') ); ?>" name="<?php echo esc_attr( $this->get_field_name('dribbble_num') ); ?>" type="text" value="<?php echo esc_attr($dribbble_num); ?>" />
        </p>
        <?php
    }
    ...
    function widget($args, $instance) {
        ...
        echo htmlspecialchars_decode( esc_html( $before_widget ) );
            if (!empty($dribbble_title)) {echo htmlspecialchars_decode( esc_html( $before_title . $dribbble_title . $after_title ) );}
