...
class flickrwidget extends WP_Widget {
    ...
    function flickrwidget() {
        ...
        parent::WP_Widget(false, 'Evatheme flickr', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr( $this->get_field_id('flickr_title') ); ?>"><?php _e('Title:', 'evatheme'); ?></label>
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id('flickr_userid') ); ?>"><?php _e('Flickr user ID:', 'evatheme'); ?></label>
            <br>
            ...
            <small><em>Find ID <a href="<?php echo esc_url( __( 'http://idgettr.com/', 'evatheme' ) ); ?>" target="_blank"><?php _e( 'http://idgettr.com/', 'evatheme' ); ?></a></em></small>
        </p>

        <p><label for="<?php echo esc_attr( $this->get_field_id('flickr_num') ); ?>"><?php _e('How many pictures display:', 'evatheme'); ?></label>
    ...
    function widget($args, $instance) {
        ...
        echo '<div class="flickr-widget">';
            echo '<div class="flickr-channel">'; ?>
                <script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo esc_js( $flickr_num ); ?>&amp;size=s&amp;layout=v&amp;source=<?php echo esc_js( $flickr_type ); ?>&amp;<?php echo esc_js( $flickr_type ); ?>=<?php echo esc_js( $flickr_userid ); ?>"></script><?php
            echo '</div>';
        echo '</div>';
