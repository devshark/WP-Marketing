function showHidePostFormatField(){    
    jQuery('#normal-sortables>[id*="eva-format-"]').each(function(){
       if(jQuery(this).attr('id').replace("eva","post")===jQuery('#post-formats-select input:radio:checked').attr('id').replace('image', '0')){
...
jQuery(function(){
    ...
    /* Select options */            
    jQuery(".eva-metaboxes select").each(function(){
        $this = jQuery(this);
    ...
    jQuery("#header_type select").change(function(){
        ...
        if( $this.val() == "subtitle" ){
            jQuery(".eva-metaboxes #subtitle").fadeIn();
			jQuery(".eva-metaboxes #bg_image").fadeIn();
            jQuery(".eva-metaboxes #breadcrumps").fadeIn();
            jQuery(".eva-metaboxes #slider_id").fadeOut();
        } else if($this.val() == "slider") {
            jQuery(".eva-metaboxes #slider_id").fadeIn();
            jQuery(".eva-metaboxes #subtitle").fadeOut();
            jQuery(".eva-metaboxes #bg_image").fadeOut();
            jQuery(".eva-metaboxes #breadcrumps").fadeOut();
        } else {
            jQuery(".eva-metaboxes #slider_id").fadeOut();
            jQuery(".eva-metaboxes #subtitle").fadeOut();
			jQuery(".eva-metaboxes #bg_image").fadeOut();
    ...
    /* Page layout options */
    jQuery(".eva-metaboxes .type_layout a").each(function(){
        $val = jQuery(".eva-metaboxes .type_layout input").val();
        $this = jQuery(this);
        if( $this.data("value") == $val ){
            $this.addClass("active");
        }
    });
    jQuery(".eva-metaboxes .type_layout a").click(function(){
        jQuery(".eva-metaboxes .type_layout a").removeClass("active");
        $val = jQuery(this).data('value');
        jQuery(".eva-metaboxes .type_layout input").val($val);
