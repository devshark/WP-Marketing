...
function kallyas_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings' => array(
            'page_title' => _x('Install Required Plugins', $theme_text_domain),
            'menu_title' => _x('Install Plugins', $theme_text_domain),
            'installing' => _x('Installing Plugin: %s', $theme_text_domain), // %1$s = plugin name
            'oops' => _x('Something went wrong with the plugin API.', $theme_text_domain),
            ...
            'return' => _x('Return to Required Plugins Installer', $theme_text_domain),
            'plugin_activated' => _x('Plugin activated successfully.', $theme_text_domain),
            'complete' => _x('All plugins installed and activated successfully. %s', $theme_text_domain) // %1$s = dashboard link
        )
    );
