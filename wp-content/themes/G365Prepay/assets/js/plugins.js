...
jQuery(document).ready(function(){
	...
	jQuery('.eva-progress-wrap').waypoint(function() {
		setTimeout(function() {
...
jQuery(document).ready(function() {
	...
	jQuery('.eva-counter-wrap').waypoint(function() {
		jQuery(".timer .count").each(function() {
...
jQuery(window).load(function(){
	setTimeout(function() {
		if(jQuery(window).width()>1025){
			jQuery('#page-title').parallax("50%",-0.5);
			jQuery('.full-width-content.bg-parallax').each(function() {
				jQuery(this).parallax("50%", -0.5);
			});
			jQuery('body.error404 #main').parallax("50%",-0.5);
		}
	}, 500);
});
...
jQuery(window).load(function(){
	...
	//Testimonials
	$('.eva-testimonials.flexslider').flexslider({
		animation: "fade",
		slideshowSpeed: 4000,
		controlNav: false,
		directionNav: false,
...
function img_slider() {
	...
	$('.loop-gallery.flexslider').flexslider({
		animation: "fade",
		slideshowSpeed: 4000,
		controlNav: true,
		directionNav: true,
