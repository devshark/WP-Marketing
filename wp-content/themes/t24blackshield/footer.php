...
<footer id="site-footer">
	<div id="footer-bottom" class="section dark">
		<div class="container clearfix">
			<div class="grid_6">
            	<p class="copyright">
                	&copy;<?php echo date('Y');?> Transact24 Trading Limited
                </p>
            </div>
            <div class="grid_6 omega">
            	<nav id="footer-nav" class="nav horizontal text-right">
                	<ul>
                    	<li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/T24%20Carholder%20Agreement%20Blackshield%20Nov%202013.pdf" target="_blank">Terms and Conditions</a></li>
                        <li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/Privacy%20Policy%20July%202011%20T24%20Blackshield.pdf" target="_blank">Privacy Policy</a></li>
                        <li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/Data%20protection%20policy%20July%202011%20T24%20Blackshield.pdf" target="_blank">Data Protection Policy</a></li>
                    </ul>
                </nav>
           	</div>
		</div>
	...
	<div id="footer-bottom" class="section dark">
		<div class="container clearfix">
            ...
            <div class="grid_6 omega">
            	<nav id="footer-nav" class="nav horizontal text-right">
                	<ul>
                    	<li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/T24%20Carholder%20Agreement%20Blackshield%20Nov%202013.pdf" target="_blank">条款与条件</a></li>
                        <li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/Privacy%20Policy%20July%202011%20T24%20Blackshield.pdf" target="_blank">隐私政策</a></li>
                        <li><a href="<?php echo esc_url( get_template_directory_uri() ); ?>/download/Data%20protection%20policy%20July%202011%20T24%20Blackshield.pdf" target="_blank">数据保护政策</a></li>
                    </ul>
                </nav>
           	</div>
		</div>
